...
solarpov_plot2 <- solarmin_plot + theme(
plot.title = element_text(color="#3cba6c", size=11, face="bold", family="mono"),
axis.title.x = element_text(color="#292929", size=10, face="bold",  family="mono"),
axis.title.y = element_text(color="#292929", size=10, face="bold", family="mono")
)
...
We found that there is a significant presence of hog farms concentrated in counties with higher poverty levels  (p-value = 0.00472). However, R-squared if fairly small (0.1165), which indicates there are likely other variables at play that are associated with where hog farms are concentrated in North Carolina. Additionally, there is a slight correlation between hog farm concentration and higher minority concentrations, but the p-value is not significant (0.21).
