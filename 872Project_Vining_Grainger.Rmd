...
```{r correlations}
#cor.test(solar_plants_NC$`Nameplate Capacity (MW)`, counties_percent$E_POV)
#main issue with correlation is that the variables have to be the same length; need to brainstorm how to do so without that
```
